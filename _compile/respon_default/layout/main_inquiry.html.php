<?php /* Template_ 2.2.8 2025/09/18 17:19:43 /gcsd33_arklink/www/data/skin/respon_default/layout/main_inquiry.html 000000992 */ ?>
<?php if($TPL_VAR["inquiry_info"]['mainview']=='y'){?>
<ul class="swiper-wrapper">
<?php if(isset($TPL_VAR["inquiry_list"]['board_list'])){?>
<?php if(is_array($TPL_R1=$TPL_VAR["inquiry_list"]['board_list'])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
